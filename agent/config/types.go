...
type Config struct {
        ...
        // DisableTMDSListTagsForResource specifies whether the agent should block calls to the TMDS ListTags endpoint
        DisableTMDSListTagsForResource BooleanDefaultFalse
